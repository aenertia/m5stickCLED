...
//PIN CONFIGURATION
#define LEDPIN 26  //strip pin. Any for ESP32, gpio2 or 3 is recommended for ESP8266 (gpio2/3 are labeled D4/RX on NodeMCU and Wemos)
//#define USE_APA102 // Uncomment for using APA102 LEDs.
#define BTNPIN 37  //button pin. Needs to have pullup (gpio0 recommended)
...
//automatically uses the right driver method for each platform
 ...
 #define PIXELMETHOD NeoEsp32I2s1800KbpsMethod
#else //esp8266
